...
def run_KNNRecommender_on_similarity_type(
    ...
    hyperparameters_range_dictionary["topK"] = Integer(50, 2000)
    hyperparameters_range_dictionary["shrink"] = Integer(50, 3000)
...
def runParameterSearch_Content(
    recommender_class,
    URM_train,
    ICM_object,
    ICM_name,
...
def runParameterSearch_Collaborative(
    recommender_class,
    URM_train,
    URM_train_last_test=None,
    metric_to_optimize="PRECISION",
    ...
    try:
        ...
        if recommender_class is P3alphaRecommender:
            ...
            hyperparameters_range_dictionary["implicit"] = Categorical([True])
        ...
        if recommender_class is MatrixFactorization_FunkSVD_Cython:
            ...
            hyperparameters_range_dictionary["negative_interactions_quota"] = Real(
                low=0.0, high=0.5, prior="uniform"
            )
        ...
        if recommender_class is IALSRecommender:
            ...
            hyperparameters_range_dictionary["confidence_scaling"] = Categorical(
                ["linear", "log"]
            )
            hyperparameters_range_dictionary["alpha"] = Real(
                low=1e-3, high=50, prior="log-uniform"
            )
            hyperparameters_range_dictionary["epsilon"] = Real(
                low=1e-3, high=30, prior="log-uniform"
            )
            hyperparameters_range_dictionary["reg"] = Real(
                low=1e-5, high=50, prior="log-uniform"
            )
        ...
        if recommender_class is PureSVDRecommender:
            ...
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["num_factors"] = Integer(1, 2500)
        ...
        if recommender_class is SLIMElasticNetRecommender:
            ...
            hyperparameters_range_dictionary["alpha"] = Real(
                low=1e-3, high=1.0, prior="uniform"
            )
