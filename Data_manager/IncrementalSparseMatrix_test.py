...
class MyTestCase(unittest.TestCase):
    def test_IncrementalSparseMatrix_add_lists(self):
        ...
        incrementalMatrix.add_data_lists(
            randomMatrix.row.copy(), randomMatrix.col.copy(), randomMatrix.data.copy()
        )
    ...
    def test_IncrementalSparseMatrix_add_rows(self):
        ...
        for row in range(n_rows):
            ...
            row_data = randomMatrix.indices[
                randomMatrix.indptr[row] : randomMatrix.indptr[row + 1]
            ]
