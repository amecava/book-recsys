...
def split_train_in_two_percentage_user_wise(
    URM_train, train_percentage=0.1, verbose=False
):
    """
    ...
    ), "train_percentage must be a value between 0.0 and 1.0, provided was '{}'".format(
        train_percentage
    )
