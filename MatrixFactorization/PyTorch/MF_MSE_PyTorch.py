...
from MatrixFactorization.PyTorch.MF_MSE_PyTorch_model import (
    MF_MSE_PyTorch_model,
    DatasetIterator_URM,
)
...
class MF_MSE_PyTorch(
    ...
    def fit(
        ...
        **earlystopping_kwargs
        ...
        self.pyTorchModel = MF_MSE_PyTorch_model(n_users, n_items, self.n_factors).to(
            self.device
        )
